<div class="space-y-8">
    ...
    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        @foreach ([
            ...
            <div class="relative flex-1 rounded-lg border border-zinc-300/80 bg-zinc-200/80 px-6 py-4 dark:border-zinc-600 dark:bg-zinc-700 {{ $loop->iteration > 1 ? 'max-md:hidden' : '' }} {{ $loop->iteration > 3 ? 'max-lg:hidden' : '' }}">
        ...
        <flux:card padding="xl" variant="subtle" class="space-y-4">
            ...
            @if ($hasArticlesTable)
                <div class="grid gap-4 sm:grid-cols-2">
                    <div class="relative flex-1 rounded-lg border border-zinc-300/80 bg-zinc-200/80 px-6 py-4 dark:border-zinc-600 dark:bg-zinc-700">
