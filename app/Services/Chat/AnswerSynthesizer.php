...
class AnswerSynthesizer
{
    ...
    private function streamingPrompt(string $question, City $city, array $seedEvidence = [], array $eventContext = []): string
    {
        ...
        $lines = [
            ...
            'If you tell the user to go somewhere, show the exact address when the evidence provides one. Format addresses as markdown links to Google Maps, e.g. [100 Main St., Springfield, IL 62701](https://www.google.com/maps/search/100+Main+St.+Springfield+IL+62701).',
    ...
    private function extractAnswerUrls(string $answer): array
    {
        ...
        return collect($matches[0] ?? [])
            ...
            ->filter()
            ->reject(fn (string $url): bool => str_starts_with($url, 'https://www.google.com/maps/'))
            ->unique()
            ->values()
            ->all();
    }
    ...
    /**
     * Judge the quality of an answer (non-blocking).
     *
     * @param  array<int, array<string, mixed>>  $seedEvidence
     */
