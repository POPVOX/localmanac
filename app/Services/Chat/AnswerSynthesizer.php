...
class AnswerSynthesizer
{
    ...
    private function streamingPrompt(string $question, City $city, array $seedEvidence = [], array $eventContext = []): string
    {
        ...
        $lines = [
            ...
            'If you tell the user to go somewhere, show the exact address when the evidence provides one. Format addresses as markdown links to Google Maps, e.g. [271 W. 3rd St. N., Wichita, KS 67202](https://www.google.com/maps/search/271+W.+3rd+St.+N.+Wichita+KS+67202).',
